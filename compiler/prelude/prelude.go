...
if (typeof app !== "undefined") { /* Revu */
  ...
  $global.console.log = console.println;
} else if (typeof window !== "undefined") { /* web page */
  $global = window;
